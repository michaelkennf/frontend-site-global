...
export const translations = {
  fr: {
    ...
    areas: {
      ...
      area1Desc: "Formation aux premiers secours, systèmes d'alerte précoce, renforcement de la résilience et reboisement.",
      area1Items: ["Formation premiers secours", "Systèmes d'alerte précoce", "Renforcement de la résilience", "Reboisement"],
      area2Title: "Urgences sanitaires & Santé sexuelle et reproductive",
      area2Desc: "Accès aux services de santé reproductive, réponse d'urgence, soutien aux femmes et filles victimes de violence.",
      area2Items: ["Accès aux services de santé reproductive", "Réponse d'urgence", "Soutien aux femmes et filles"],
      area3Title: "Justice climatique et environnementale",
      area3Desc: "Sensibilisation environnementale, gestion des déchets, protection de la biodiversité et agriculture résiliente au climat.",
      area3Items: ["Sensibilisation environnementale", "Gestion des déchets", "Protection de la biodiversité", "Agriculture résiliente"],
    },
    stats: {
      title: "Notre impact",
  ...
  en: {
    ...
    areas: {
      ...
      area1Desc: "Community first aid training, early warning systems, resilience building and reforestation.",
      area1Items: ["Community first aid training", "Early warning systems", "Resilience building", "Reforestation"],
      area2Title: "Health Emergencies & Sexual and Reproductive Health",
      area2Desc: "Access to reproductive health services, emergency response, support for women and girls affected by violence.",
      area2Items: ["Access to reproductive health services", "Emergency response", "Support for women and girls"],
      area3Title: "Climate and Environmental Justice",
      area3Desc: "Environmental awareness, waste management, biodiversity protection and climate resilient agriculture.",
      area3Items: ["Environmental awareness", "Waste management", "Biodiversity protection", "Climate resilient agriculture"],
    },
    stats: {
      title: "Our Impact",
