...
export const SITE_TEXT_CATALOG: SiteTextCatalogEntry[] = [
  ...
  { section: "about", key: "about.pageTitle", label: "Page À propos — Titre hero", multiline: false, defaultFr: fr.about.title, defaultEn: en.about.title },
  { section: "about", key: "about.pageSubtitle", label: "Page À propos — Sous-titre hero", multiline: true, defaultFr: fr.about.description, defaultEn: en.about.description },
  { section: "about", key: "about.title", label: "Qui sommes-nous — Titre", multiline: false, defaultFr: fr.about.whoWeAreTitle, defaultEn: en.about.whoWeAreTitle },
  { section: "about", key: "about.description", label: "Qui sommes-nous — Texte", multiline: true, defaultFr: fr.about.whoWeAreParagraphs.join("\n\n"), defaultEn: en.about.whoWeAreParagraphs.join("\n\n") },
  { section: "about", key: "about.mission", label: "Mission — Titre", multiline: false, defaultFr: fr.about.mission, defaultEn: en.about.mission },
  { section: "about", key: "about.missionText", label: "Mission — Texte", multiline: true, defaultFr: fr.about.missionText, defaultEn: en.about.missionText },
  { section: "about", key: "about.vision", label: "Vision — Titre", multiline: false, defaultFr: fr.about.vision, defaultEn: en.about.vision },
  { section: "about", key: "about.visionText", label: "Vision — Texte", multiline: true, defaultFr: fr.about.visionText, defaultEn: en.about.visionText },
  { section: "about", key: "about.values", label: "Valeurs — Titre section", multiline: false, defaultFr: fr.about.values, defaultEn: en.about.values },
  { section: "about", key: "about.principles", label: "Principes — Titre section", multiline: false, defaultFr: fr.about.principles, defaultEn: en.about.principles },
